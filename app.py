...
def fetch_poster(movie_id):
    response=requests.get('https://api.themoviedb.org/3/movie/{}?api_key=5be1576269a2fedec9a0265195b2f057&append_to_response=images&language=en-US'.format(movie_id))
    data=response.json()
